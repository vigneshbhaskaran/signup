...
class _MenuState extends State<Menu> {
 ...
 @override
 void dispose() {                           //***this will clean up or dispose the values
    ...
    return SafeArea(
      child: Form(
        ...
        fontWeight: FontWeight.bold,
             ...
             validator: (value) {    //validates the value inside the textformfield , wghether it satisfies the conditions  ,   we can write the conditions/validations below as you can see
